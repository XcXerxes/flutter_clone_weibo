...
VideoModel _$VideoModelFromJson(Map<String, dynamic> json) {
  return VideoModel()
    ...
    ..videotime = json['videotime'] as num
    ..playnum = json['playnum'] as num
    ...
    ..userisvertify = json['userisvertify'] as num
    ..zannum = json['zannum'] as num
    ..videourl = json['videourl'] as String
    ..userfancount = json['userfancount'] as num
